//
//  SelectionSheetViewController.swift
//  Weekand
//
...
class SelectionSheetViewController: BottomSheetViewController {
    ...
    var viewModel: SelectionSheetViewModel?
    ...
    private func bindViewModel() {
        ...
        let input = SelectionSheetViewModel.Input(
...
extension SelectionSheetViewController: UICollectionViewDataSource {
...
extension SelectionSheetViewController: UICollectionViewDelegate {
